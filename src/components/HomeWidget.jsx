        ...
        <div>
            <div className='flex-1 border-x-2'>
                ...
                <div className='flex p-3 w-full border-b-2'>
                    <img src="https://avatarfiles.alphacoders.com/198/198645.jpg" alt="profile-img" className='w-12 h-12 object-cover rounded-full text-center' />
                    <div className='flex flex-col w-full px-3'>
                        <input type="text" placeholder="what's on your mind?" className='bg-transparent text-2xl h-20  outline-none hocus:ring-0' />
                        <div className='flex items-center justify-around text-blue-500'>
                            ...
                            {/* tweet */}
                            <button className="bg-blue-500 px-3 py-2 rounded-full text-xl text-white hover:bg-blue-600">Tweet</button>
                        </div>
                    </div>
                </div>
            </div>
